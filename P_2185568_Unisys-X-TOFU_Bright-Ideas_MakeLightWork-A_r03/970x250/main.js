...
function animate() {
  ...
  tl.from(split.words, 0.5, { y: 25, opacity: 0, filter: "blur(7px)", stagger: 0.2, ease: "power2.out" }, 0.5)
  .to(".copy2", 0.5, { autoAlpha:1, ease: "power1.inOut" }, 2.5)
  .to(cta, 0.5, { autoAlpha:1, ease: "power1.inOut" }, 3.5)
}
